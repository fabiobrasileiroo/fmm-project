    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4">
        <div className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-primary mb-4">Contato</h1>
          <p className="text-gray-600 max-w-3xl">
            Entre em contato conosco para mais informações sobre os projetos, agendar uma visita ou estabelecer
            parcerias.
          </p>
        </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Av. Fundação Matias Machline, 1000
                        <br />
                        Distrito Industrial
                        <br />
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">(92) 3XXX-XXXX</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">contato@fmm.org.br</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-6">
              <Card>
                <CardContent className="p-6">
                  ...
                  <div className="aspect-video bg-gray-200 rounded-md w-full"></div>
                  <p className="text-sm text-gray-500 mt-2">Mapa será carregado aqui</p>
                </CardContent>
              </Card>
            </div>
          </div>
